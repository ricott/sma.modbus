...
PVOutputClient.prototype.publishStatus = function (values) {
    var self = this;

    let timestamp = new Date();
    let date = `${timestamp.getFullYear()}${utility.pad(timestamp.getMonth() + 1, 2)}${utility.pad(timestamp.getDate(), 2)}`;
