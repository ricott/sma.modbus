...
//    console.log(decodeData.decodeDeviceType(results[0].response._body._valuesAsArray[1]));
    ...
    properties.maxPower = decodeData.decodeU32(results[3].response._body._valuesAsArray, 0, 0);
...
/*
    debug('DC current input 1', results[11].response._body._valuesAsArray, decodeData.decodeU32(results[0].response._body._valuesAsArray, 0, 0));
...
*/
    ...
    readings.dailyYield = decodeData.formatWHasKWH(decodeData.decodeU32(results[7].response._body._valuesAsArray, 0, 0));
    readings.totalYield = decodeData.formatWHasMWH(decodeData.decodeU32(results[8].response._body._valuesAsArray, 0, 0));
