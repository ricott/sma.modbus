...
SMA.prototype.initListenersAndConnect = function () {
  ...
  self.socket.on('connect', function () {
    console.log(`Client connected on IP '${self.options.host}'`);
    self.connected = true;
...
SMA.prototype.isDailyYieldManual = function () {
  var self = this;
  return inverterType.isDailyYieldManual(self.modbusSettings);
}
