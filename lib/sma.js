...
class SMA extends HomeyEventEmitter {
  ...
  //Invoked from the device once all capabilities are configured
  initilializeTimers() {
    var self = this;
  ...
  setMaxActivePowerOutput(power) {
    ...
    return this.client.writeMultipleRegisters(40915, buffer)
      .then((result) => {
