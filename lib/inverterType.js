...
const { STP, STP_TL10, STP_JP, STP_TLEE, STP_TLEE_JP, STP_40, STP_SE } = require('./inverters/stp.js');
const { SB, SB_JP22, SB_TLST21, SB_SE10, SB_4041 } = require('./inverters/sb.js');
const { SHP_20 } = require('./inverters/shp.js');
const { SBS, SBS_VL, SI, SI11 } = require('./inverters/sbs.js');
const { BASIC } = require('./inverters/basic.js');
const { TRIPOWERX, CORE1 } = require('./inverters/tripower.js');

exports.getModbusRegistrySettings = function (deviceType) {
    let type = BASIC;

    if (deviceType.startsWith('Tripower')) {
