...
const type = {
    ...
    U64_FIX0: { format: 'U64', decimalsIn: 0, decimalsOut: 0 },
...
class ModbusRegistry {
    ...
    // Number of contiguous Modbus registers this value spans.
    // SMA U64 values use 4 registers; everything else uses 2.
    get registerCount() {
        return (this._type && this._type.format === 'U64') ? 4 : 2;
    }
    ...
    readData(dataArray) {
        ...
        } else if (this._type.format === 'U64') {
            return decodeData.decodeU64(dataArray, this._type.decimalsIn, this._type.decimalsOut);
