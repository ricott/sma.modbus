...
const BASE = Object.freeze({
    ...
    batteryChargeTotal: new ModbusRegistry(setting.READING, 31397, type.U64_FIX0, 'Total battery charge Wh', 'meter_power.charged'),
    batteryDischargeTotal: new ModbusRegistry(setting.READING, 31401, type.U64_FIX0, 'Total battery discharge Wh', 'meter_power.discharged'),
