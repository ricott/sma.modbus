...
class Base extends HomeyEventEmitter {
  ...
  constructor(deviceRegistryHandler, options = {}) {
    ...
    this._logMessage('DEBUG', `Initializing with options: host=${this.options.host}, port=${this.options.port}, refreshInterval=${this.options.refreshInterval}, timeout=${this.options.timeout}, autoClose=${this.options.autoClose}`);
